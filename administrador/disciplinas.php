            ...
            <div class="row col-sm-12 d-md-flex d-sm-flex flex-sm-column flex-xs-column flex-md-row">
                    ...
                    <div class="card d-flex mb-4">
                        <div class="card-header rounded-0">
                            <div class="container-sm text-center pt-2 ">
                                <h2 style="text-align:center; font-size:larger">AGREGAR NUEVA DISCIPLINA</h2>
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                    <input type="text" required value="<?php echo $disciplina; ?>" <?php echo ($accion == "seleccionar") ? "disabled" : "" ?> class="form-control" id="disciplina" name="disciplina" placeholder="Añade una disciplina">
                                </div>
                                ...
                                <div class="col-sm-12 mt-3 mb-3">
                                    ...
                                    switch ($accion) {
                                        ...
                                        case "agregar":
                                            ...
                                            $sql = $conexion->prepare("INSERT INTO disciplinas(nombre_disciplina) VALUES(:nombre_disciplina);");
                                            $sql->bindParam(':nombre_disciplina', $disciplina);
                                            $sql->execute();
                                            echo <<<EOT
                                        ...
                                        case "eliminar":
                                            ...
                                            $sql = $conexion->prepare("DELETE FROM disciplinas WHERE id = :id");
                                    ...
                                    $sql = $conexion->prepare("SELECT * FROM disciplinas ORDER BY id DESC");
                                    $sql->execute();
                ...
                <div class="col-sm col-md-6 col-xl-7 col-sm-12 col-xs-12 fb-page mt-4 mb-4">
                    <table class="table table-responsive table-bordered mb-4">
                        ...
                        <tbody>
                            <?php if (empty($listarDisciplinas)) {
                                echo <<<EOT
                                ...
                                foreach ($listarDisciplinas as $dato) { ?>
                                    <tr>
                                        <td hidden><?php echo $dato['id'] ?></td>
                                        <td align="center"><?php echo $dato['nombre_disciplina'] ?></td>
                                        <td align="center">
